...
public class FileExtensionValidatorTest extends ValidatorTestCase {
  private static final Set<String> BLOCKED_EXTENSIONS_LC =
      Sets.newHashSet("jpeg", "pdf", "zip", "exe", "tar.gz");
  private static final Set<String> BLOCKED_EXTENSIONS_UC =
      Sets.newHashSet("JPEG", "PDF", "ZIP", "EXE", "TAR.GZ");

  private RevCommit makeCommit(Set<String> blockedExtensions)
