...
public class SymlinkValidatorTest extends ValidatorTestCase {
  ...
  public void testWithSymlink() throws Exception {
    ...
    String msg1 = "Symbolic links are not allowed: foo.txttrue";
    String msg2 = "Symbolic links are not allowed: symbolicFoldertrue";
  ...
  public void testDefaultValue() {
    assertThat(SymlinkValidator.isActive(TestUtils.getEmptyPluginConfig()))
        .isFalse();
  }
}
