...
public class EmailWhitelistTest {
  ...
  public void testEmailValid() throws Exception {
    assertThat(EmailWhitelistValidator.performValidation("tester@example.com", emailWhitelist))
        .isTrue();
  ...
  public void testEmailInvalid() throws Exception {
    assertThat(EmailWhitelistValidator.performValidation("test@android.com", emailWhitelist))
        .isFalse();
    ...
    assertThat(EmailWhitelistValidator.performValidation("tester@google.com.net", emailWhitelist))
        .isFalse();
    assertThat(EmailWhitelistValidator.performValidation("tester@gerri.net", emailWhitelist))
        .isFalse();
  }
