...
public class ContentTypeValidatorTest extends ValidatorTestCase {
  ...
  static private ContentTypeValidator ctv = new ContentTypeValidator(null,
      new ContentTypeUtil(PATTERN_CACHE), null, null);

  static private byte[] getExamplePDF() {
    String pdf = "%PDF-1.4\n"
  ...
  public void testBlocked() throws Exception {
    ...
    List<CommitValidationMessage> m = ctv.performValidation(
        repo, c, patterns, false);
