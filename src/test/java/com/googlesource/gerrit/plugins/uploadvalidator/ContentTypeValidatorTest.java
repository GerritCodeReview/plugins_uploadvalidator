...
public class ContentTypeValidatorTest extends ValidatorTestCase {
  ...
  public void testBlocked() throws Exception {
    ...
    List<CommitValidationMessage> m = ContentTypeValidator.performValidation(
        repo, c, patterns, false, new ContentTypeUtil(PATTERN_CACHE));
  ...
  public void testWhitelist() throws Exception {
    ...
    RevCommit c = makeCommit();
    List<CommitValidationMessage> m = ContentTypeValidator.performValidation(
        repo, c, patterns, true, new ContentTypeUtil(PATTERN_CACHE));
    assertThat(TestUtils.transformMessages(m))
    .containsExactly(
        "ERROR: found blocked content type (text/html) in file: foo.html");
  }
