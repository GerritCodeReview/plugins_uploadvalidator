...
public class SubmoduleValidator implements CommitValidationListener {
  public static String KEY_CHECK_SUBMODULE = "submodule";
  ...
  public List<CommitValidationMessage> onCommitReceived(
    ...
    try {
      ...
      boolean submoduleCheck = cfg.getBoolean(KEY_CHECK_SUBMODULE, false);
        ...
        try (Repository repo = repoManager.openRepository(
          ...
          if (receiveEvent.commit.getParentCount() > 1) {
            ...
            while (tw.next()) {
              ...
              if (((tw.getRawMode(0) & FileMode.TYPE_MASK) == FileMode.TYPE_GITLINK)
                  && diff) {
