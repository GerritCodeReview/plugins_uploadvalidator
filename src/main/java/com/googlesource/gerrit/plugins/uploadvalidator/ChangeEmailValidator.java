...
public class ChangeEmailValidator implements CommitValidationListener {
  public static AbstractModule module() {
    return new AbstractModule() {
      ...
      public void configure() {
        ...
        bind(ProjectConfigEntry.class)
            .annotatedWith(Exports.named(KEY_ALLOWED_EMAIL_PATTERN))
            .toInstance(
                new ProjectConfigEntry(
  ...
  public static final String KEY_ALLOWED_EMAIL_PATTERN = "allowedEmailPattern";
  ...
  static String[] getAllowedAuthorEmailPatterns(PluginConfig cfg) {
    return ObjectArrays.concat(
        ...
        cfg.getStringList(KEY_ALLOWED_EMAIL_PATTERN),
        String.class);
  }
  ...
  static String[] getAllowedChangeEmailPatterns(PluginConfig cfg) {
    return cfg.getStringList(KEY_ALLOWED_EMAIL_PATTERN);
  }
  ...
  static boolean isChangeActive(PluginConfig cfg) {
    return cfg.getStringList(KEY_ALLOWED_EMAIL_PATTERN).length > 0;
  }
