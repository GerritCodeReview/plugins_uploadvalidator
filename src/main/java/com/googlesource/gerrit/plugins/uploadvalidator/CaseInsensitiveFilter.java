  ...
  public boolean include(TreeWalk tw)
    ...
    if(isDeleted(tw)) {
      ...
      for (String searchPath : searchEntity.keySet()) {
        // We are in a subtree. If the currentPath equal to the searchPathDepth
        // the depth of all paths in this subtree is greater than the
        // searchPathDepth. Because of this it is important that currentPathDepth
        // is smaller than searchPathDepth
