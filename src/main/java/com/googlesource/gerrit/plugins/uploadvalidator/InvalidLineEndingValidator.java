...
public class InvalidLineEndingValidator implements CommitValidationListener {
  ...
  static boolean doCheckInvalidLineEndings(PluginConfig cfg) {
    ...
    try {
      ...
      try (Repository repo =
        ...
        List<CommitValidationMessage> messages =
            performValidation(repo, receiveEvent.commit, cfg, contentTypeUtil);
        if (!messages.isEmpty()) {
  ...
  static List<CommitValidationMessage> performValidation(Repository repo,
      RevCommit c, PluginConfig cfg, ContentTypeUtil contentTypeUtil)
