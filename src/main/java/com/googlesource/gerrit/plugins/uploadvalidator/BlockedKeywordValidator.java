...
public class BlockedKeywordValidator implements CommitValidationListener {
  ...
  public List<CommitValidationMessage> onCommitReceived(
    ...
    try {
      ...
      ImmutableMap<String, Pattern> blockedKeywordPartterns =
      ...
      try (Repository repo =
        ...
        List<CommitValidationMessage> messages = performValidation(repo,
            receiveEvent.commit, blockedKeywordPartterns);
        if (!messages.isEmpty()) {
  ...
  static List<CommitValidationMessage> performValidation(Repository repo,
      RevCommit c, ImmutableMap<String, Pattern> blockedKeywordPartterns)
          throws IOException {
  ...
  private static void checkLineForBlockedKeywords(
    ...
    for (Pattern p : blockedKeywordPartterns.values()) {
