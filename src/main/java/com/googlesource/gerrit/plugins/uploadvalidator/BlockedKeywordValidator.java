...
import com.google.gerrit.extensions.validators.CommentValidationException;
...
public class BlockedKeywordValidator implements CommitValidationListener, CommentValidator {
  ...
  @Nullable
  private static CommentValidationFailure validateComment(
  ...
  public ImmutableList<CommentValidationFailure> validateComments(
    ...
    try {
      ...
      throw new CommentValidationException("Exception validating comments in uploadvalidator", e);
    }
