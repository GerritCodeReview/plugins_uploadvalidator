...
public class DuplicatePathnameValidator implements CommitValidationListener {
  ...
  private boolean areDuplicatePathnamesAllowed(CommitReceivedEvent receiveEvent)
  ...
  public List<CommitValidationMessage> onCommitReceived(
    ...
    try {
      if (areDuplicatePathnamesAllowed(receiveEvent)) {
  ...
  static List<CommitValidationMessage> performValidation(Repository repo,
    ...
    checkForDuplicatesWithinThisSet(files, messages);
    if (messages.isEmpty()) {
