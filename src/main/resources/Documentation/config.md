...
:	Binary types.
	...
	Checks which support this feature:
	 - InvalidLineEndingCheck
	 - BlockedKeywordValidator

	This check is using Apache Tika [2] to detect content types.

	You can specify a content type like this:
	 - image/gif
	 - image/bmp
	 - application/zip

	You can find a full list of supported content types [here][3].
